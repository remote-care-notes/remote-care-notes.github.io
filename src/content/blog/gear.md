...
> 以下に並ぶ機材紹介には **Amazon アソシエイトおよび楽天アフィリエイトの広告（PR）** を含む商品リンクが入っています。6年使ってきた実体験ベースで紹介していますが、購入の判断はご自身でお願いします。
...
6年運用してきて思うのは、Bot に入れる **CR2 リチウム電池は Panasonic 一択** ということです。
